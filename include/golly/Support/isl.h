...
CLOSED_UNOP(union_map, curry, isl_union_map_curry);
CLOSED_UNOP(union_map, uncurry, isl_union_map_uncurry);
CLOSED_UNOP(union_map, range_reverse, isl_union_map_range_reverse);
