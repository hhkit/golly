...
entry:
  ...
  %1 = tail call i32 @llvm.nvvm.read.ptx.sreg.tid.x() #2, !dbg !25
  %idxprom2 = zext i32 %1 to i64, !dbg !27
  %arrayidx32 = getelementptr inbounds [0 x i32], [0 x i32] addrspace(3)* @p, i64 0, i64 %idxprom2, !dbg !27
  %arrayidx3 = addrspacecast i32 addrspace(3)* %arrayidx32 to i32*, !dbg !27
  store i32 1, i32* %arrayidx3, align 4, !dbg !28, !tbaa !21
  ret void, !dbg !29
}
...
!24 = !{!"Simple C++ TBAA"}
!25 = !DILocation(line: 53, column: 3, scope: !16, inlinedAt: !26)
!26 = distinct !DILocation(line: 9, column: 5, scope: !11)
!27 = !DILocation(line: 9, column: 3, scope: !11)
!28 = !DILocation(line: 9, column: 18, scope: !11)
!29 = !DILocation(line: 11, column: 1, scope: !11)
